...
const CTA: React.FC<CTAProps> = ({ onContactClick }) => {
  return (
    <section id="contact" className="py-40 px-6">
      <div className="max-w-7xl mx-auto p-16 md:p-32 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center">
          <h2 className="text-5xl md:text-9xl font-[900] mb-12 leading-[1] tracking-tighter">
            Ready To Transform Your Idea Into <span className="text-gradient-brand">Impact?</span>
          </h2>
          <p className="text-gray-400 text-xl md:text-3xl max-w-4xl mx-auto mb-16 font-light leading-relaxed">
            Ideas flow. Share your project. Our experts will reach out quickly to discuss how we can shape your story.
          </p>
