      ...
      <div className="max-w-6xl">
        ...
        <div className="flex flex-col">
          {SERVICES.map((service, idx) => (
            <div
              key={idx}
              className="service-item group relative py-8 px-5 md:py-16 border-b border-zinc-900/50 flex flex-col lg:flex-row lg:items-center justify-between transition-all duration-700 cursor-pointer overflow-hidden opacity-0 translate-y-12"
