      ...
      <div className="max-w-4xl mx-auto px-5 sm:px-6 md:px-12 relative z-10 w-full pt-20 md:pt-12">
        <div className="text-center mb-12 md:mb-24">
          ...
          <p className="text-gray-400 text-lg md:text-lg max-w-2xl mx-auto font-light leading-relaxed text-left md:text-center mt-4">
            ...
            At PresentoLab, we respect your privacy and are committed to protecting the personal information you share with us. This Privacy Policy explains how we collect, use, and safeguard your data when you interact with our services. We do not share phone numbers or SMS consent data with third parties or affiliates for marketing or unrelated purposes.
          </p>
        </div>

        <div className="space-y-10 md:space-y-16 text-gray-300 font-light leading-relaxed text-lg md:text-lg break-words">
